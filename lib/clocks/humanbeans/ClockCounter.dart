...
class ClockCounter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: <Widget>[
        Padding(
            padding: EdgeInsets.only(bottom: model.utils.scaleDimentions(100)),
            child: hoursTens),
        Padding(
            padding: EdgeInsets.only(bottom: model.utils.scaleDimentions(60)),
            child: hoursOnes),
        SizedBox(
        ...
        Padding(
            padding: EdgeInsets.only(bottom: model.utils.scaleDimentions(120)),
            child: minutesTens),
        Padding(
            padding: EdgeInsets.only(bottom: model.utils.scaleDimentions(40)),
            child: minutesOnes),
      ],
    );
  }
