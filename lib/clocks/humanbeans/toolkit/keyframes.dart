...
class Interpolation<T> extends Animatable<T?> {
  ...
  Interpolation({
    required List<Keyframe<T>> keyframes
        ...
        this.keyframes = _sorted(keyframes) as List<Keyframe<T?>>;
  ...
  T? _interpolate(double t) {
    ...
    late Keyframe fromKeyframe;
    late Keyframe toKeyframe;
...
class ColorInterpolation extends Interpolation<Color> {
  ...
  ColorInterpolation({
    required List<Keyframe<Color>> keyframes
...
class OffsetInterpolation extends Interpolation<Offset> {
  ...
  OffsetInterpolation({
    required List<Keyframe<Offset>> keyframes
  }): super(keyframes: keyframes);
